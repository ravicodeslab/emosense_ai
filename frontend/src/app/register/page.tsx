    ...
    <div className="flex w-full min-h-screen items-center justify-center p-4">
      <div className="glass-card w-full max-w-md p-8">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold mb-2 text-slate-800 dark:text-white">Create Account</h1>
          <p className="text-slate-500 text-sm">Start your wellbeing journey today</p>
        </div>
